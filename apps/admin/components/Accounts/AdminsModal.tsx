...
interface IAdminsModal {
	isOpen: boolean;
	onClose: () => void;
}

export const AdminsModal: React.FC<IAdminsModal> = ({ isOpen, onClose }) => {
	return (
				...
				>
					...
					>
						...
						<Text
							...
							textAlign={"center"}
						>
							Lembre-se de que contas admin possuem poder de edição no sistema.
						</Text>
					</Flex>
					<Flex flex={"1"} flexDir={"column"} py={"1.5rem"} px={"1.625rem"}>
						<Text
							color={"#007D99"}
							fontSize={"1.25rem"}
							fontWeight={"500"}
